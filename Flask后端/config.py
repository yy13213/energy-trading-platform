...
# 数据库相关配置
HOSTNAME = '127.0.0.1'  # MySQL 本地地址
PORT = 3306              # SQL Server 默认端口（命名实例需调整）
DATABASE = 'flask_ces'  # 数据库名称保持不变
USERNAME = 'root'      # SQL Server 账户名（需具有访问权限）
PASSWORD = 'root'    # SQL Server 密码
...
#admin_address = '0x9a7a921a104718a1cf3fc351c47c307db5a6103b'
#admin_address = '0x588617dfc799576d79374fe7b6c577f5c6a3939c'
admin_address = '0x84703c57a736246296d33ad2efa22126afba5c9e'  # 使用已注册的用户地址作为管理员
